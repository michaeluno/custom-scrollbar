 ...
 * @version    1.0.0
 */
class CSS_Files_Minifier extends PHP_Class_Files_Script_Generator_Base {
    ...
    static protected $_aStructure_Options = array(
        ...
        // Search options
        'search'    =>    array(
            'allowed_extensions' => array( 'css' ),    // e.g. array( 'js', )
    ...
    private function _minifyFiles( array $aFiles, array $aOptions, $sHeaderComment )  {
        ...
        foreach( $aFiles as $_iIndex => $_sFilePath ) {
            ...
            $_sContent = $this->_getCSSMinified( file_get_contents( $_sFilePath ) );
         ...
         * @return      string
         */
        private function _getFileExtensionReplaced( $sFilePath, $sNewExtension='min.css' ) {
         ...
         * @return      string
         */
        private function _getCSSMinified( $sCSSRules ) {            
            return str_replace( 
