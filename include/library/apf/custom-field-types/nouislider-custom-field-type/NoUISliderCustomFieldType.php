...
if ( ! class_exists( 'CustomScrollbar_NoUISliderCustomFieldType' ) ) :
/**
 ...
 */
class CustomScrollbar_NoUISliderCustomFieldType extends CustomScrollbar_AdminPageFramework_FieldType_text {
