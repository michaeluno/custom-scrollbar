...
/**
	...
	Copyright (c) 2013-2015, Michael Uno; Licensed under MIT <http://opensource.org/licenses/MIT> Included Components: Admin Pages, Utilities
 Generated on 2016-01-05 */
if (!class_exists('CustomScrollbar_AdminPageFramework_Registry')):
    abstract class CustomScrollbar_AdminPageFramework_Registry_Base {
        const VERSION = '3.7.9b03';
    ...
    final class CustomScrollbar_AdminPageFramework_Registry extends CustomScrollbar_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['CustomScrollbar_AdminPageFramework_InclusionClassFilesHeader']) && file_exists(self::$aClassFiles['CustomScrollbar_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('CustomScrollbar_AdminPageFramework_Bootstrap')):
