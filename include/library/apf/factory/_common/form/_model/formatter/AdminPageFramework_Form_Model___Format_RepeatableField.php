...
class CustomScrollbar_AdminPageFramework_Form_Model___Format_RepeatableSection extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : CustomScrollbar_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class CustomScrollbar_AdminPageFramework_Form_Model___Format_RepeatableField extends CustomScrollbar_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
