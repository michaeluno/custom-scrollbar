...
class CustomScrollbar_AdminPageFramework_FieldType_submit extends CustomScrollbar_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".custom-scrollbar-field input[type='submit'] {margin-bottom: 0.5em;}.custom-scrollbar-field-submit .submit-confirm-container {display: inline-block;margin-left: 1em;vertical-align: middle;}.custom-scrollbar-field-submit .field-error.submit-confirmation-warning {float: none;}";
    }
    protected function getScripts() {
        return <<<JAVASCRIPTS
jQuery( document ).ready( function(){
    jQuery( '.custom-scrollbar-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
        jQuery( this ).closest( '.custom-scrollbar-field-submit' ).find( 'input[type=submit]' ).on( 'click', function( event ){
            var _fieldSubmit = jQuery( this ).closest( '.custom-scrollbar-field-submit' );  
            _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
            var _confirmCheckbox = jQuery( this ).closest( '.custom-scrollbar-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
