...
class CustomScrollbar_AdminPageFramework_FieldType_submit extends CustomScrollbar_AdminPageFramework_FieldType {
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'custom-scrollbar-input-label-container' . ' custom-scrollbar-input-button-container' . ' custom-scrollbar-input-container',);
    }
