...
class CustomScrollbar_AdminPageFramework_FieldType_select extends CustomScrollbar_AdminPageFramework_FieldType {
    ...
    class CustomScrollbar_AdminPageFramework_FieldType_size extends CustomScrollbar_AdminPageFramework_FieldType_select {
        ...
        protected function getStyles() {
            return ".custom-scrollbar-field-size input {text-align: right;}.custom-scrollbar-field-size select.size-field-select {vertical-align: 0px; }.custom-scrollbar-field-size label {width: auto; } .form-table td fieldset .custom-scrollbar-field-size label {display: inline-block;}";
        }
        protected function getField($aField) {
