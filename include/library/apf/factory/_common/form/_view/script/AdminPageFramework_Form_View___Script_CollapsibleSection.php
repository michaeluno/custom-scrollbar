...
( function( $ ) {
    ...
    $.fn.initializeCustomScrollbar_AdminPageFrameworkCollapsibleSections = function() {
        ...
        jQuery( this ).find( '.custom-scrollbar-collapsible-sections-title, .custom-scrollbar-collapsible-section-title' )
            .enableCustomScrollbar_AdminPageFrameworkCollapsibleButton();
    ...
    $.fn.enableCustomScrollbar_AdminPageFrameworkCollapsibleButton = function() {
        ...
        function _isFieldElement( nodeTarget ) {
            ...
            if ( jQuery( nodeTarget ).hasClass( 'custom-scrollbar-collapsible-button' ) ) {
                return false;
            }
