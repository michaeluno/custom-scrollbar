...
(function ( $ ) {
    ...
    $.fn.updateCustomScrollbar_AdminPageFrameworkRepeatableFields = function( aSettings ) {
        ...
        var _oRepeatableButtons = $( nodeThis ).find( '.custom-scrollbar-repeatable-field-buttons' )
            .filter( function() {                                       
                return $( this ).closest( '.custom-scrollbar-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
            });       
...
// @todo event.preventDefault();        
        ...
        var _sFieldID           = _oRepeatableAddButtons.first().closest( '.custom-scrollbar-field' ).attr( 'id' );
        var _nCurrentFieldCount = $( '#' + _sFieldsContainerID ).find( '.custom-scrollbar-field' )
            .filter( function() {                 
                return $( this ).closest( '.custom-scrollbar-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
            })        
            .length;
    ...
    $.fn.addCustomScrollbar_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        ...
        if ( ! _aOptions ) {     
            var _nodeButtonContainer = nodeFieldContainer.find( '.custom-scrollbar-repeatable-field-buttons' )
                .filter( function() {                 
                    return $( this ).closest( '.custom-scrollbar-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                })
                .first();
        ...
        var _oInnerFields       = nodeFieldsContainer.find( '.custom-scrollbar-field' ) 
                                    .filter( function() {                 
                                        return $( this ).closest( '.custom-scrollbar-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                                    });
        var _oRepeatableButtons = nodeFieldContainer.find( '.custom-scrollbar-repeatable-field-buttons' )
                                    .filter( function() {                 
                                        return $( this ).closest( '.custom-scrollbar-fields' ).attr( 'id' ) === _sFieldsContainerID;  // Avoid dealing with nested field's elements.                
                                    }); 
        ...
        $( nodeNewField ).find( '.custom-scrollbar-field' ).addBack().trigger( 
            'custom-scrollbar_repeated_field', 
            [ 
                0, // call type, 0 : repeatable fields, 1: repeatable sections
                jQuery( nodeNewField ).closest( '.custom-scrollbar-fields' )    // model container
            ]
        );
        ...
        var nodeRemoveButtons = nodeFieldsContainer
            ...
            .filter( function() {                      
                return $( this ).closest( '.custom-scrollbar-fields' ).attr( 'id' ) === _sFieldsContainerID;                
            })
