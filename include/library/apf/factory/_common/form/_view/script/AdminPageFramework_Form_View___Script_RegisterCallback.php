...
(function ( $ ) {
     ...
     */  
    $( document ).on( 'custom-scrollbar_added_repeatable_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){          
     ...
     */
    $( document ).on( 'custom-scrollbar_repeated_field', function( oEvent, iCallType, oModelContainer ){
     ...
     * @since       3.8.0
     */
    $( document ).on( 'custom-scrollbar_stopped_sorting_sections', function( oEvent ){  
     ...
     */
    /* $( document ).on( 'custom-scrollbar_removed_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){
        var _oThisNode = jQuery( oEvent.target );
