...
class CustomScrollbar_AdminPageFramework_Form_View___ToolTip extends CustomScrollbar_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span class='custom-scrollbar-form-tool-tip-description'>" . implode("</span><span class='custom-scrollbar-form-tool-tip-description'>", $this->getAsArray($this->aArguments['content'])) . "</span>";
        }
        return '';
    }
}
