...
class CustomScrollbar_AdminPageFramework_Form_View___SectionTitle extends CustomScrollbar_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getDebugInfo($aSectionset) {
        ...
        $_oToolTip = new CustomScrollbar_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('section_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => CustomScrollbar_AdminPageFramework_Debug::getDetails($aSectionset) . '<span class="custom-scrollbar-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aSectionset['_section_path'] . '_debug');
        return $_oToolTip->get();
    }
