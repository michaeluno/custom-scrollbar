...
abstract class CustomScrollbar_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        CustomScrollbar_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return CustomScrollbar_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        CustomScrollbar_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return CustomScrollbar_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        CustomScrollbar_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        CustomScrollbar_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        CustomScrollbar_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'CustomScrollbar_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
    ...
    class CustomScrollbar_AdminPageFramework_Utility extends CustomScrollbar_AdminPageFramework_Utility_HTMLAttribute {
        static public function getHTTPRequestSanitized(array $aRequest, $bStripSlashes) {
            foreach ($aRequest as $_isIndex => $_mValue) {
                if (is_array($_mValue)) {
                    $aRequest[$_isIndex] = self::getHTTPRequestSanitized($_mValue, false);
                    continue;
                }
