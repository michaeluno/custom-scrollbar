...
class CustomScrollbar_AdminPageFramework_Debug_Base extends CustomScrollbar_AdminPageFramework_FrameworkUtility {
    ...
    class CustomScrollbar_AdminPageFramework_Debug_Log extends CustomScrollbar_AdminPageFramework_Debug_Base {
    ...
    class CustomScrollbar_AdminPageFramework_Debug extends CustomScrollbar_AdminPageFramework_Debug_Log {
        ...
        static public function dumpArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('CustomScrollbar_AdminPageFramework_Debug::' . __FUNCTION__, 'CustomScrollbar_AdminPageFramework_Debug::dump()');
            CustomScrollbar_AdminPageFramework_Debug::dump($asArray, $sFilePath);
        }
        static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
            self::showDeprecationNotice('CustomScrollbar_AdminPageFramework_Debug::' . __FUNCTION__, 'CustomScrollbar_AdminPageFramework_Debug::get()');
            return CustomScrollbar_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
        }
        static public function logArray($asArray, $sFilePath = null) {
            self::showDeprecationNotice('CustomScrollbar_AdminPageFramework_Debug::' . __FUNCTION__, 'CustomScrollbar_AdminPageFramework_Debug::log()');
            CustomScrollbar_AdminPageFramework_Debug::log($asArray, $sFilePath);
        }
        static public function getAsString($mValue) {
            self::showDeprecationNotice('CustomScrollbar_AdminPageFramework_Debug::' . __FUNCTION__);
