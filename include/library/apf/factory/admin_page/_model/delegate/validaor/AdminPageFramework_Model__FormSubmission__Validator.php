...
class CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator extends CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Link', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Import', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Export', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'CustomScrollbar_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
