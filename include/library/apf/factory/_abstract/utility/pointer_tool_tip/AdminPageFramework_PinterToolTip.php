<?php
class CustomScrollbar_AdminPageFramework_PointerToolTip extends CustomScrollbar_AdminPageFramework_WPUtility {
    ...
    public function _replyToInsertInlineScript() {
        echo "<script type='text/javascript' class='custom-scrollbar-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInlineScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
