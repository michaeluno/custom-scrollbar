...
class CustomScrollbar_AdminPageFramework_Form_View___ToolTip extends CustomScrollbar_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        return '' . "<a href='{$_sHref}' class='custom-scrollbar-form-tooltip'>" . $this->_getTipLinkIcon() . "<span class='custom-scrollbar-form-tooltip-content'>" . $this->_getTipTitle() . $this->_getDescriptions() . "</a>";
    }
    ...
    private function _getTipTitle() {
        if (isset($this->aArguments['title'])) {
            return "<span class='custom-scrollbar-form-tool-tip-title'>" . $this->aArguments['title'] . "</span>";
        }
        return '';
    }
    private function _getDescriptions() {
        if (isset($this->aArguments['content'])) {
            return "<span class='custom-scrollbar-form-tool-tip-description'>" . $this->aArguments['content'] . "</span>";
        }
        return '';
    }
}