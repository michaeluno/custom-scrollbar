...
class CustomScrollbar_AdminPageFramework_FieldType_submit extends CustomScrollbar_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Submit Buttons */
.custom-scrollbar-field input[type='submit'] {
    margin-bottom: 0.5em;
}
CSSRULES;
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";" : null, 'class' => 'custom-scrollbar-input-label-container' . ' custom-scrollbar-input-button-container' . ' custom-scrollbar-input-container',);
    }
