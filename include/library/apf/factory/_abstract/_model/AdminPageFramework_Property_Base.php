<?php
abstract class CustomScrollbar_AdminPageFramework_Property_Base extends CustomScrollbar_AdminPageFramework_WPUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = $this->getAOrB(empty($sTextDomain), 'custom-scrollbar', $sTextDomain);
        $this->sStructureType = $sStructureType;
        $GLOBALS['aCustomScrollbar_AdminPageFramework'] = $this->getElementAsArray($GLOBALS, 'aCustomScrollbar_AdminPageFramework', array('aFieldFlags' => array()));
