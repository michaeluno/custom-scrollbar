<?php
class CustomScrollbar_AdminPageFramework_AdminNotice {
    public function __construct($sNotice, array $aAttributes = array('class' => 'error')) {
        ...
        $this->aAttributes['class'] = $this->oUtil->getClassAttribute($this->oUtil->getElement($this->aAttributes, array('class'), ''), 'custom-scrollbar-settings-notice-message', 'notice is-dismissible');
