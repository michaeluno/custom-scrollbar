<?php
class CustomScrollbar_AdminPageFramework_PageLoadInfo_NetworkAdminPage extends CustomScrollbar_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new CustomScrollbar_AdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
