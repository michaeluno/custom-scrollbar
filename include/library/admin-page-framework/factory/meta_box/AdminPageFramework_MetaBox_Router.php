<?php
abstract class CustomScrollbar_AdminPageFramework_MetaBox_Router extends CustomScrollbar_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'admin-page-framework') {
        ...
        parent::__construct(isset($this->oProp) ? $this->oProp : new CustomScrollbar_AdminPageFramework_Property_MetaBox($this, $_sClassName, $sCapability));
