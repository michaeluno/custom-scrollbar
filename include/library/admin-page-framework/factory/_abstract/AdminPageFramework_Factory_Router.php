...
abstract class CustomScrollbar_AdminPageFramework_Factory_Router {
    ...
    protected $_aFormElementClassNameMap = array('page' => 'CustomScrollbar_AdminPageFramework_FormDefinition_Page', 'network_admin_page' => 'CustomScrollbar_AdminPageFramework_FormDefinition_Page', 'post_meta_box' => 'CustomScrollbar_AdminPageFramework_FormDefinition_Meta', 'page_meta_box' => 'CustomScrollbar_AdminPageFramework_FormDefinition', 'post_type' => 'CustomScrollbar_AdminPageFramework_FormDefinition', 'taxonomy' => 'CustomScrollbar_AdminPageFramework_FormDefinition', 'widget' => 'CustomScrollbar_AdminPageFramework_FormDefinition', 'user_meta' => 'CustomScrollbar_AdminPageFramework_FormDefinition_Meta',);
    ...
    protected $_aResourceClassNameMap = array('page' => 'CustomScrollbar_AdminPageFramework_Resource_Page', 'network_admin_page' => 'CustomScrollbar_AdminPageFramework_Resource_Page', 'post_meta_box' => 'CustomScrollbar_AdminPageFramework_Resource_MetaBox', 'page_meta_box' => 'CustomScrollbar_AdminPageFramework_Resource_MetaBox_Page', 'post_type' => 'CustomScrollbar_AdminPageFramework_Resource_PostType', 'taxonomy' => 'CustomScrollbar_AdminPageFramework_Resource_TaxonomyField', 'widget' => 'CustomScrollbar_AdminPageFramework_Resource_Widget', 'user_meta' => 'CustomScrollbar_AdminPageFramework_Resource_UserMeta',);
    ...
    protected $_aHelpPaneClassNameMap = array('page' => 'CustomScrollbar_AdminPageFramework_HelpPane_Page', 'network_admin_page' => 'CustomScrollbar_AdminPageFramework_HelpPane_Page', 'post_meta_box' => 'CustomScrollbar_AdminPageFramework_HelpPane_MetaBox', 'page_meta_box' => 'CustomScrollbar_AdminPageFramework_HelpPane_MetaBox_Page', 'post_type' => null, 'taxonomy' => 'CustomScrollbar_AdminPageFramework_HelpPane_TaxonomyField', 'widget' => 'CustomScrollbar_AdminPageFramework_HelpPane_Widget', 'user_meta' => 'CustomScrollbar_AdminPageFramework_HelpPane_UserMeta',);
    ...
    protected $_aLinkClassNameMap = array('page' => 'CustomScrollbar_AdminPageFramework_Link_Page', 'network_admin_page' => 'CustomScrollbar_AdminPageFramework_Link_NetworkAdmin', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'CustomScrollbar_AdminPageFramework_Link_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    protected $_aPageLoadClassNameMap = array('page' => 'CustomScrollbar_AdminPageFramework_PageLoadInfo_Page', 'network_admin_page' => 'CustomScrollbar_AdminPageFramework_PageLoadInfo_NetworkAdminPage', 'post_meta_box' => null, 'page_meta_box' => null, 'post_type' => 'CustomScrollbar_AdminPageFramework_PageLoadInfo_PostType', 'taxonomy' => null, 'widget' => null, 'user_meta' => null,);
    ...
    public function _replyTpSetAndGetInstance_oDebug() {
        $this->oDebug = new CustomScrollbar_AdminPageFramework_Debug;
        return $this->oDebug;
    }
    public function _replyTpSetAndGetInstance_oMsg() {
        $this->oMsg = CustomScrollbar_AdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
        return $this->oMsg;
    }
