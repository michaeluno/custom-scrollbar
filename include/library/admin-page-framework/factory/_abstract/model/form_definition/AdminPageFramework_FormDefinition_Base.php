<?php
abstract class CustomScrollbar_AdminPageFramework_FormDefinition_Base extends CustomScrollbar_AdminPageFramework_WPUtility {
    public function dropRepeatableElements(array $aOptions) {
        $_oFilterRepeatableElements = new CustomScrollbar_AdminPageFramework_Modifier_FilterRepeatableElements($aOptions, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->sFieldsType));
