<?php
abstract class CustomScrollbar_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $this->sTextDomain = $this->oUtil->getAOrB(empty($sTextDomain), 'custom-scrollbar', $sTextDomain);
        $this->sFieldsType = $sFieldsType;
        $GLOBALS['aCustomScrollbar_AdminPageFramework'] = isset($GLOBALS['aCustomScrollbar_AdminPageFramework']) && is_array($GLOBALS['aCustomScrollbar_AdminPageFramework']) ? $GLOBALS['aCustomScrollbar_AdminPageFramework'] : array('aFieldFlags' => array());
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : CustomScrollbar_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
