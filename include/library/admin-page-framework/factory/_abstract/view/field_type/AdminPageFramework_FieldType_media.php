...
.custom-scrollbar-field-media input {
    margin-right: 0.5em;
...
jQuery( document ).ready( function(){     
    setCustomScrollbar_AdminPageFrameworkMediaUploader( '{$sInputID}', '{$bRpeatable}', '{$bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-scrollbar-media-uploader-button'>" . $_sScript . "</script>" . PHP_EOL;
    }
