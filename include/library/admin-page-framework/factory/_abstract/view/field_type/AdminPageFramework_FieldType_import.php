...
class CustomScrollbar_AdminPageFramework_FieldType_import extends CustomScrollbar_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Import Field */
.custom-scrollbar-field-import input {
    margin-right: 0.5em;
}
.custom-scrollbar-field-import label,
.form-table td fieldset.custom-scrollbar-fieldset .custom-scrollbar-field-import label { /* for Wordpress 3.8 or above */
