...
.custom-scrollbar-field .image_preview {
    border: none; 
    clear: both; 
    margin-top: 0.4em;
    margin-bottom: 0.8em;
...
.custom-scrollbar-field .image_preview img {     
    display: block;  
    height: auto; 
    max-width: 100%;
}
.widget .custom-scrollbar-field .image_preview {
    max-width: 100%;
}            
...
.custom-scrollbar-field-image input {
    margin-right: 0.5em;
...
jQuery( document ).ready( function(){     
    setCustomScrollbar_AdminPageFrameworkImageUploader( '{$sInputID}', '{$bRpeatable}', '{$bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-scrollbar-image-uploader-button'>" . $_sScript . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-scrollbar-{$sType}-remove-button'>" . $_sScript . "</script>" . PHP_EOL;
    }
