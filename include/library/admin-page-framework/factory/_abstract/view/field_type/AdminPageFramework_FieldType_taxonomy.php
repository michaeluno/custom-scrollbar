...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Taxonomy Field Type */
.custom-scrollbar-field .taxonomy-checklist li { 
    margin: 8px 0 8px 20px; 
}
.custom-scrollbar-field div.taxonomy-checklist {
    padding: 8px 0 8px 10px;
    margin-bottom: 20px;
}
.custom-scrollbar-field .taxonomy-checklist ul {
    list-style-type: none;
    margin: 0;
}
.custom-scrollbar-field .taxonomy-checklist ul ul {
    margin-left: 1em;
}
.custom-scrollbar-field .taxonomy-checklist-label {
    /* margin-left: 0.5em; */
    white-space: nowrap;     
}    
/* Tabbed box */
.custom-scrollbar-field .tab-box-container.categorydiv {
    max-height: none;
}
.custom-scrollbar-field .tab-box-tab-text {
    display: inline-block;
}
.custom-scrollbar-field .tab-box-tabs {
    line-height: 12px;
    margin-bottom: 0;
}
/* .custom-scrollbar-field .tab-box-tab {     
    vertical-align: top;
} */
.custom-scrollbar-field .tab-box-tabs .tab-box-tab.active {
    display: inline;
...
.custom-scrollbar-field .tab-box-container { 
    position: relative; 
    width: 100%; 
    clear: both;
    margin-bottom: 1em;
}
.custom-scrollbar-field .tab-box-tabs li a { color: #333; text-decoration: none; }
.custom-scrollbar-field .tab-box-contents-container {  
    padding: 0 0 0 1.8em;
    padding: 0.55em 0.5em 0.55em 1.8em;
    border: 1px solid #dfdfdf; 
    background-color: #fff;
}
.custom-scrollbar-field .tab-box-contents { 
    overflow: hidden; 
    overflow-x: hidden; 
    position: relative; 
    top: -1px; 
...
.custom-scrollbar-field .tab-box-content { 
...
.custom-scrollbar-field .tab-box-content .taxonomychecklist {
    margin-right: 3.2em;
}
.custom-scrollbar-field .tab-box-content:target, 
.custom-scrollbar-field .tab-box-content:target, 
.custom-scrollbar-field .tab-box-content:target { 
    display: block; 
}  
/* tab-box-content */
.custom-scrollbar-field .tab-box-content .select_all_button_container, 
.custom-scrollbar-field .tab-box-content .select_none_button_container
{
    margin-top: 0.8em;
}
/* Nested Checkbox Items */
.custom-scrollbar-field .taxonomychecklist .children {
    margin-top: 6px;
    margin-left: 1em;
}
CSSRULES;
