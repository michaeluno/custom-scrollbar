...
class CustomScrollbar_AdminPageFramework_FieldType_system extends CustomScrollbar_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return <<<CSSRULES
.custom-scrollbar-field-system {
    width: 100%;
}
.custom-scrollbar-field-system .custom-scrollbar-input-label-container {
    width: 100%;
}
.custom-scrollbar-field-system textarea {
...
CSSRULES;
    ...
    protected function getField($aField) {
        ...
        return $aField['before_label'] . "<div class='custom-scrollbar-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span class='custom-scrollbar-input-label-string' style='min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";'>" . $aField['label'] . "</span>" : "") . "<textarea " . $this->getAttributes($_aInputAttributes) . " >" . esc_textarea($this->_getSystemInfomation($aField['value'], $aField['data'], $aField['print_type'])) . "</textarea>" . $aField['after_input'] . "</label>" . "</div>" . $aField['after_label'];
    }
