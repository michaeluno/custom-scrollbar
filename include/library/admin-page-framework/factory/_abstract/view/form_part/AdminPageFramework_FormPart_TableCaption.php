...
class CustomScrollbar_AdminPageFramework_FormPart_TableCaption extends CustomScrollbar_AdminPageFramework_FormPart_Base {
    ...
    private function _getCaption(array $aSection, $hfSectionCallback, $iSectionIndex, $aFields, $hfFieldCallback, $aFieldErrors, $aFieldTypeDefinitions, $oMsg) {
        ...
        return "<caption " . $this->getAttributes(array('class' => 'custom-scrollbar-section-caption', 'data-section_tab' => $aSection['section_tab_slug'],)) . ">" . $_oCollapsibleSectionTitle->get() . $this->getAOrB($_bShowTitle, $this->_getCaptionTitle($aSection, $iSectionIndex, $aFields, $hfFieldCallback, $aFieldTypeDefinitions), '') . $this->_getCaptionDescription($aSection, $hfSectionCallback) . $this->_getSectionError($aSection, $aFieldErrors) . "</caption>";
    }
    ...
    private function _getCaptionTitle($aSection, $iSectionIndex, $aFields, $hfFieldCallback, $aFieldTypeDefinitions) {
        ...
        return "<div " . $this->getAttributes(array('class' => 'custom-scrollbar-section-title', 'style' => $this->getAOrB($this->_shouldShowCaptionTitle($aSection, $iSectionIndex), '', 'display: none;'),)) . ">" . $_oSectionTitle->get() . "</div>";
    }
    private function _getCaptionDescription($aSection, $hfSectionCallback) {
        ...
        $_oSectionDescription = new CustomScrollbar_AdminPageFramework_FormPart_Description($aSection['description'], 'custom-scrollbar-section-description');
        return "<div class='custom-scrollbar-section-description'>" . call_user_func_array($hfSectionCallback, array($_oSectionDescription->get(), $aSection)) . "</div>";
    }
