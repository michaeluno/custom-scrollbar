<?php
class CustomScrollbar_AdminPageFramework_Script_CollapsibleSection extends CustomScrollbar_AdminPageFramework_Script_Base {
...
( function( $ ) {
    ...
    jQuery( document ).ready( function() {
        ...
        jQuery( '.custom-scrollbar-collapsible-sections-title[data-is_collapsed=\"0\"]' )
            .next( '.custom-scrollbar-collapsible-sections-content' )
            .slideDown( 'fast' );
        jQuery( '.custom-scrollbar-collapsible-section-title[data-is_collapsed=\"0\"]' )
        ...
        jQuery( '.custom-scrollbar-collapsible-section-title[data-is_collapsed=\"1\"]' )
            .closest( '.custom-scrollbar-section-table' )
            .find( 'tbody' )
            .hide();
        
        // Bind the click event
        jQuery( '.custom-scrollbar-collapsible-sections-title, .custom-scrollbar-collapsible-section-title' ).enableCustomScrollbar_AdminPageFrameworkCollapsibleButton();
        
        // Insert the toggle all button.
        jQuery( '.custom-scrollbar-collapsible-title[data-toggle_all_button!=\"0\"]' ).each( function(){
