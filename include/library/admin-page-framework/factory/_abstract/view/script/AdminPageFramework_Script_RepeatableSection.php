<?php
class CustomScrollbar_AdminPageFramework_Script_RepeatableSection extends CustomScrollbar_AdminPageFramework_Script_Base {
...
// @todo Change the selector name 'repeatable-section-add-button' to something else to avoid apf version conflict.
    ...
    $.fn.addCustomScrollbar_AdminPageFrameworkRepeatableSection = function( sSectionContainerID ) {
        ...
        var nodeTabsContainer       = $( '#' + sSectionContainerID ).closest( '.custom-scrollbar-sections' ).find( '.custom-scrollbar-section-tabs' );
    ...
    $.fn.removeCustomScrollbar_AdminPageFrameworkRepeatableSection = function() {
        ...
        var sSectionsContainerID    = nodeSectionsContainer.attr( 'id' );
        var nodeTabsContainer       = nodeSectionsContainer.find( '.custom-scrollbar-section-tabs' );
        var nodeTabs                = nodeTabsContainer.find( '.custom-scrollbar-section-tab' );
        var _iSectionIndex          = nodeSectionsContainer.attr( 'data-largest_index' );
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-scrollbar-section-repeatable-script'>" . $_sScript . "</script>";
    }
}