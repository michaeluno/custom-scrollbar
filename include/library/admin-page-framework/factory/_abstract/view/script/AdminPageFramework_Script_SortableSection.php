<?php
class CustomScrollbar_AdminPageFramework_Script_SortableSection extends CustomScrollbar_AdminPageFramework_Script_SortableField {
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-scrollbar-section-sortable-script'>" . $_sScript . "</script>";
    }
}