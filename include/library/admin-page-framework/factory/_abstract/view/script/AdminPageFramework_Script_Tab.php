<?php
class CustomScrollbar_AdminPageFramework_Script_Tab extends CustomScrollbar_AdminPageFramework_Script_Base {
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='custom-scrollbar-section-tabs-script'>" . $_sScript . "</script>";
    }
}