<?php
class CustomScrollbar_AdminPageFramework_Script_RepeatableField extends CustomScrollbar_AdminPageFramework_Script_Base {
...
(function ( $ ) {
    ...
    $.fn.updateCustomScrollbar_AdminPageFrameworkRepeatableFields = function( aSettings ) {
        ...
        if ( ! $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions.hasOwnProperty( sFieldsContainerID ) ) {     
            $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ] = $.extend({    
        ...
        var _aOptions = $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ];
        ...
        var _nCurrentFieldCount = jQuery( '#' + sFieldsContainerID ).find( '.custom-scrollbar-field' ).length;
    ...
    $.fn.addCustomScrollbar_AdminPageFrameworkRepeatableField = function( sFieldContainerID ) {
        ...
        if ( ! $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions.hasOwnProperty( sFieldsContainerID ) ) {     
            ...
            $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ] = {    
        ...
        var _iFadein  = $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'fadein' ];
        var _iFadeout = $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'fadeout' ];

        // Show a warning message if the user tries to add more fields than the number of allowed fields.
        var sMaxNumberOfFields = $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ]['max'];
    ...
    $.fn.removeCustomScrollbar_AdminPageFrameworkRepeatableField = function() {
        ...
        var sMinNumberOfFields  = $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'min' ];
        if ( sMinNumberOfFields != 0 && nodeFieldsContainer.find( '.custom-scrollbar-field' ).length <= sMinNumberOfFields ) {
            ...
            var _iFadeout = $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'fadeout' ]
                ? $.fn.aCustomScrollbar_AdminPageFrameworkRepeatableFieldsOptions[ sFieldsContainerID ][ 'fadeout' ]
                : 500;
            nodeMessage.delay( 2000 ).fadeOut( _iFadeout );
            return;     
        }     
