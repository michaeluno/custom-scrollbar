...
abstract class CustomScrollbar_AdminPageFramework_Factory_View extends CustomScrollbar_AdminPageFramework_Factory_Model {
    ...
    public function _replyToGetFieldOutput($aField) {
        $_oField = new CustomScrollbar_AdminPageFramework_FormField($aField, $this->oProp->aOptions, $this->_getFieldErrors(), $this->oProp->aFieldTypeDefinitions, $this->oMsg, $this->oProp->aFieldCallbacks);
