...
abstract class CustomScrollbar_AdminPageFramework_FieldType_Base extends CustomScrollbar_AdminPageFramework_WPUtility {
    ...
    protected function geFieldOutput(array $aField) {
        ...
        $_oField = new CustomScrollbar_AdminPageFramework_FormField($aField, $_aOptions, $_oCaller->getFieldErrors(), $_oCaller->oProp->aFieldTypeDefinitions, $_oCaller->oMsg, $_oCaller->oProp->aFieldCallbacks);
