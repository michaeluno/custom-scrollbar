<?php
class CustomScrollbar_AdminPageFramework_Property_Page extends CustomScrollbar_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses']) ? $GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses'] : array();
