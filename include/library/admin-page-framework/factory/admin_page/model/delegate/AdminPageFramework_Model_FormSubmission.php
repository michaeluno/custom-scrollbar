<?php
class CustomScrollbar_AdminPageFramework_Model_FormSubmission extends CustomScrollbar_AdminPageFramework_Model_FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory) {
        $this->oFactory = $oFactory;
        add_action("load_after_{$this->oFactory->oProp->sClassName}", array($this, '_replyToProcessFormData'), 21);
        new CustomScrollbar_AdminPageFramework_Model_FormRedirectHandler($oFactory);
        new CustomScrollbar_AdminPageFramework_Model_FormEmailHandler($oFactory);
    }
    public function _replyToProcessFormData() {
        ...
        new CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator($this->oFactory);
    ...
    private function _getUserInputsFromPOST() {
        ...
        return $this->oFactory->getSortedInputs($_aInputs);
    }
