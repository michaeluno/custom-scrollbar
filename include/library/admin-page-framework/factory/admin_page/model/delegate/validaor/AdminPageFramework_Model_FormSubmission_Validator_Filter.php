<?php
class CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_Filter extends CustomScrollbar_AdminPageFramework_Model_FormSubmission_Base {
    public $oFactory;
    ...
    private function _getFiltered($aInputs, $aRawInputs, $aStoredData, $aSubmitInformation) {
        ...
        $this->oFactory->_setLastInput($aRawInputs);
