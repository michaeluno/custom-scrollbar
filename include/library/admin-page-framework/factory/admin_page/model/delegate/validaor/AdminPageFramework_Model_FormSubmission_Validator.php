<?php
class CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator extends CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_ContactForm', 'CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_ResetConfirm', 'CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_Link', 'CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_Redirect', 'CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_Import', 'CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_Export', 'CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_Reset', 'CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new CustomScrollbar_AdminPageFramework_Model_FormSubmission_Validator_Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
