<?php
abstract class CustomScrollbar_AdminPageFramework_Menu_Model extends CustomScrollbar_AdminPageFramework_Page_Controller {
    ...
    public function _replyToBuildMenu() {
        ...
        foreach ($this->oProp->aPages as & $aSubMenuItem) {
            $_oFormatter = new CustomScrollbar_AdminPageFramework_Format_SubMenuItem($aSubMenuItem, $this);
