<?php
abstract class CustomScrollbar_AdminPageFramework_Form_Controller extends CustomScrollbar_AdminPageFramework_Form_View {
    ...
    public function getValue() {
        ...
        return CustomScrollbar_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oProp->getDefaultOptions($this->oForm->aFields));
    }
