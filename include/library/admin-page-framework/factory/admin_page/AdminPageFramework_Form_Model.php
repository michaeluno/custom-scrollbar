<?php
abstract class CustomScrollbar_AdminPageFramework_Form_Model extends CustomScrollbar_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'custom-scrollbar') {
        ...
        new CustomScrollbar_AdminPageFramework_Model_FormRegistration($this);
        new CustomScrollbar_AdminPageFramework_Model_FormSubmission($this);
