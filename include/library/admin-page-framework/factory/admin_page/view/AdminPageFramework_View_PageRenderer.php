<?php
class CustomScrollbar_AdminPageFramework_View_PageRenderer extends CustomScrollbar_AdminPageFramework_WPUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    private function _getContentTop() {
        $_oScreenIcon = new CustomScrollbar_AdminPageFramework_View_PageRenderer_ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new CustomScrollbar_AdminPageFramework_View_PageRenderer_PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new CustomScrollbar_AdminPageFramework_View_PageRenderer_InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _getFormOutput($sPageSlug) {
        ...
        $_oFieldsTable = new CustomScrollbar_AdminPageFramework_FormPart_Table($this->oFactory->oProp->aFieldTypeDefinitions, $this->oFactory->aFieldErrors, $this->oFactory->oMsg);
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new CustomScrollbar_AdminPageFramework_View_PageMataBoxRenderer();
