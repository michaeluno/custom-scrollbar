<?php
class CustomScrollbar_AdminPageFramework_Property_MetaBox_Page extends CustomScrollbar_AdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['aCustomScrollbar_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['aCustomScrollbar_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['aCustomScrollbar_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['aCustomScrollbar_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
        $GLOBALS['aCustomScrollbar_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['aCustomScrollbar_AdminPageFramework']['aPageClasses'] as $__oClass) {
