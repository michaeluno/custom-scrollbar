...
class CustomScrollbar_AdminPageFramework_FormPart_TableRow extends CustomScrollbar_AdminPageFramework_FormPart_Base {
    ...
    protected function _getRow(array $aFieldset, $hfCallback) {
        ...
        $_oFieldrowAttribute = new CustomScrollbar_AdminPageFramework_Attribute_Fieldrow($aFieldset, array('id' => 'fieldrow-' . $aFieldset['tag_id'], 'valign' => 'top', 'class' => 'admin-page-framework-fieldrow',));
