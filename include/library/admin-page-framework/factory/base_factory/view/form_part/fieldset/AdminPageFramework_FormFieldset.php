<?php
class CustomScrollbar_AdminPageFramework_FormFieldset extends CustomScrollbar_AdminPageFramework_FormFieldset_Base {
    public function get() {
        $_aOutput = array();
        ...
        $_oFieldsFormatter = new CustomScrollbar_AdminPageFramework_Format_Fields($this->aField, $this->aOptions);
    ...
    private function _getEachFieldOutput(array $aField, $isIndex, array $aCallbacks, $bIsLastElement = false) {
        ...
        $_oSubFieldFormatter = new CustomScrollbar_AdminPageFramework_Format_EachField($aField, $isIndex, $aCallbacks, $_aFieldTypeDefinition);
        $aField = $_oSubFieldFormatter->get();
        $_oFieldAttribute = new CustomScrollbar_AdminPageFramework_Attribute_Field($aField);
    ...
    private function _getExtras($aField, $iFieldsCount) {
        $_aOutput = array();
        $_oFieldDescription = new CustomScrollbar_AdminPageFramework_FormPart_Description($aField['description'], 'admin-page-framework-fields-description');
