...
class CustomScrollbar_AdminPageFramework_FormPart_DebugInfo extends CustomScrollbar_AdminPageFramework_FormPart_Base {
    ...
    public function get() {
        ...
        return "<div class='admin-page-framework-info'>" . 'Debug Info: ' . CustomScrollbar_AdminPageFramework_Registry::NAME . ' ' . CustomScrollbar_AdminPageFramework_Registry::getVersion() . "</div>";
    }
}