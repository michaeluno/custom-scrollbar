<?php
class CustomScrollbar_AdminPageFramework_Attribute_SectionsTablesContainer extends CustomScrollbar_AdminPageFramework_Attribute_Base {
    ...
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new CustomScrollbar_AdminPageFramework_Generate_SectionName($aSectionset, $aSectionset['_caller_object']->oProp->aFieldCallbacks['hfSectionName']);
