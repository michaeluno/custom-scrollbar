<?php
class CustomScrollbar_AdminPageFramework_Property_PostType extends CustomScrollbar_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        switch ($this->_getCallerType($sCallerPath)) {
            case 'theme':
                add_action('after_switch_theme', array('CustomScrollbar_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
            case 'plugin':
                register_activation_hook($sCallerPath, array('CustomScrollbar_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
                register_deactivation_hook($sCallerPath, array('CustomScrollbar_AdminPageFramework_WPUtility', 'FlushRewriteRules'));
            break;
        }
    }
}