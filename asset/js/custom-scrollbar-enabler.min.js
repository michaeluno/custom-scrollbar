...
(function($){$.fn.initializeCustomScrollbars=function($aScrollbars){$.each($aScrollbars,function(_iIndex,_aScrollbar){_setInlineCSS(_aScrollbar);var _aScrollbarOptions=_getScrollbarOptions(_aScrollbar);$(_aScrollbar.selector).mCustomScrollbar('destroy').mCustomScrollbar(_aScrollbarOptions);_setCustomColors(_aScrollbar,_iIndex);if('undefined'!==typeof custom_scrollbar_enabler&&custom_scrollbar_enabler.debugMode)console.log('Custom Scrollbar Option',_aScrollbarOptions)})}
